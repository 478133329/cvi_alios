...
#define VPSS_CLK_CTRL_MASK ((1 << VPSS_CLK_CTRL_IMGD_BIT) |  \
                            (1 << VPSS_CLK_CTRL_IMGV_BIT) |  \
                            (1 << VPSS_CLK_CTRL_SCTOP_BIT) | \
                            (1 << VPSS_CLK_CTRL_SCD_BIT) |   \
                            (1 << VPSS_CLK_CTRL_SCV1_BIT) |  \
                            (1 << VPSS_CLK_CTRL_SCV2_BIT) |  \
                            (1 << VPSS_CLK_CTRL_SCV3_BIT))

// vo suspend clk mask
#define VO_CLK_CTRL_MASK ((1 << VO_CLK_CTRL_BT_BIT) |  \
                            (1 << VO_CLK_CTRL_DISP_BIT) |  \
                            (1 << VO_CLK_CTRL_DSIMAC_BIT))
