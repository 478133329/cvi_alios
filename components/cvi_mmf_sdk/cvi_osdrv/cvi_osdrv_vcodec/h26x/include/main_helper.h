...
void setRoiMapFromMap(int coreIdx, TestEncConfig *encConfig, EncOpenParam *pEncOP,
	      PhysicalAddress addrRoiMap, Uint8 *roiMapBuf, EncParam *encParam,
	      int maxCtuNum);
...
int allocateRoiMapBuf(int coreIdx, TestEncConfig *pEncConfig, vpu_buffer_t *vbRoi, int srcFbNum, int ctuNum);
...
int setCtuModeMap(int coreIdx, TestEncConfig *pEncConfig, EncOpenParam *pEncOP,
		PhysicalAddress addrCtuModeMap, Uint8 *ctuModeMapBuf, int srcFrameWidth,
		int srcFrameHeight, EncParam *encParam, int maxCtuNum);

int allocateCtuQpMapBuf(int coreIdx, TestEncConfig *pEncConfig, vpu_buffer_t *vbCtuQp, int srcFbNum, int ctuNum);
